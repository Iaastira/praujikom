...
<head>
	...
	<link href="frontend/assets/03-regular-page/css/styles.css" rel="stylesheet">
	
	<link href="frontend/assets/03-regular-page/css/responsive.css" rel="stylesheet">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="content">
						...
						<div class="img-wrapper"><img src="frontend/assets/images/regular-content-1-1000x650.jpg" alt="Content Image"></div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="img-wrapper"><img src="frontend/assets/images/regular-content-2-600x400.jpg" alt="Content Image"></div>
							</div><!-- col-sm-6 -->
							<div class="col-sm-6">
								<div class="img-wrapper"><img src="frontend/assets/images/regular-content-3-600x400.jpg" alt="Content Image"></div>
							</div><!-- col-sm-6 -->
						</div><!-- row -->
						...
						<div class="img-wrapper"><img src="frontend/assets/images/regular-content-4-1000x650.jpg" alt="Content Image"></div>
